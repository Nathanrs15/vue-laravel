...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    login: function login() {
      this.loading = true; // get the redirect object
      ...
      this.$auth.login({
        ...
        success: function success() {
          ...
          var redirectTo = redirect ? redirect.from.name : this.$auth.user().roleId === 1 ? "admin.dashboard" : "dashboard";
          this.$router.push({
            name: redirectTo
          });
        },
    ...
    [
      _c(
        ...
        [
          _c(
            "material-card",
            { attrs: { color: "primary", title: "Iniciar sesión" } },
            [
              _c(
                "v-form",
                {
...
webpackEmptyContext.id = "./resources/js/router sync recursive";
